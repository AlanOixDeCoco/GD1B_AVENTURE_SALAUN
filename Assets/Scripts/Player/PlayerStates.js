...
export class IdlePlayerState extends State {
    ...
    onEnterState(){
        ...
        this._context._sprite.body.setVelocity(0, 0);
        this._context._sprite.anims.play(this._context._animations.idle);
    }
...
export class MovingPlayerState extends State {
    ...
    Update(){
        ...
        this._context._sprite.body.setVelocity(
        ...
        this._context._sprite.anims.play(this._context._animations.moveDown, true);

        if((this._context._input.y == 0) || (this._context._sprite.body.velocity.x != 0)){
            this._context._sprite.flipX = ((this._context._sprite.body.velocity.x) > 0) ? false : true;
        }
